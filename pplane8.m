...
if strcmp(action,'initialize')
  ...
  meload = uimenu('Parent',mefile,'label','Load a system ...',...
		  'call','pplane8(''loadsyst'',''system'');',...
		  'pos',1);
  mesave = uimenu('Parent',mefile,'label','Save the current system ...',...
		  'call','pplane8(''savesyst'',''system'');',...
		  'pos',2);
  meloadg = uimenu('Parent',mefile,'label','Load a gallery ...',...
		   'call','pplane8(''loadsyst'',''gallery'');',...
		   'separator','on','pos',3);
  mesaveg = uimenu('Parent',mefile,'label','Save a gallery ...',...
		   'call','pplane8(''savesyst'',''gallery'');',...
		   'tag','savegal','pos',4);
  medelg = uimenu('Parent',mefile,'label','Delete the current gallery',...
		  'call',delgall,'pos',5);
  melddg = uimenu('Parent',mefile,'label','Load the default gallery',...
		  'call','pplane8(''loadsyst'',''default'');',...
		  'enable','on',...
		  'tag','load default','pos',6);
  merevert = uimenu('Parent',mefile,'label','Revert','call',...
		    'pplane8(''revert'')',...
		    'separator','on','pos',7);
  meproceed = uimenu('Parent',mefile,...
		     'label','Proceed',...
		     'call','pplane8(''proceed'')',...
		     'separator','off',...
		     'accelerator','G','pos',8);
  ...
  merestart = uimenu('Parent',mefile,'label',...
		     'Restart pplane8',...
		     'call','pplane8(''restart'')',...
		     'separator','on','pos',12);
  
  mequit = uimenu('Parent',mefile,...
		  'label','Quit pplane8',...
		  'call','pplane8(''quit'')',...
  ...
  meclrf = uimenu('Parent',meedit,'label','Clear equations',...
  ...
  meclrp = uimenu('Parent',meedit,'label','Clear parameters',...
      'call',pclear,...
      'accelerator','N');
  
  meclrwind = uimenu('Parent',meedit,'label','Clear display window',...
  ...
  meclrall = uimenu('Parent',meedit,'label','Clear all',...
      'call',allclear,...
      'accelerator','A',...
      'separator','on');
   ...
   if (sud.flag == 1)
	...
	otherwise
	 ...
	 set(gcf,'defaultuicontrolfontsize',fs*0.9);
       ...
       merestart = uimenu('Parent',fmenu,'label',...
			  'Restart pplane8',...
			  'call','pplane8(''restart'')',...
			  'separator','on');
       mequit = uimenu('Parent',fmenu,'label','Quit pplane8',...
       ...
       emenu = findobj(ppdisp,'label','&Edit',...
		       'pos',2); 
       menu(2) = uimenu('Parent',emenu,'label','Zoom in.',...
			'call','pplane8(''zoomin'')',...
			'pos',1);
       
       zsqmenu = uimenu('Parent',emenu,'label','Zoom in square.',...
			'call','pplane8(''zoominsq'')',...
			'pos',2);
       
       zbmenu = uimenu('Parent',emenu,'label','Zoom back.','call',...
		       'pplane8(''zoomback'')',...
		       'enable','off','tag','zbmenu',...
		       'pos',3);
       
       medallsol = uimenu('Parent',emenu,'label','Erase all solutions.',...
			  'call','pplane8(''dallsol'')',...
			  'separator','on','pos',4);
       
       medallep = uimenu('Parent',emenu,'label','Erase all equilibrium points.',...
			 'call','pplane8(''dallep'')',...
			 'separator','off',...
			 'pos',5);
       
       medallics = uimenu('Parent',emenu,'label','Erase all marked initial points.',...
			 'call','pplane8(''dallics'')',...
			 'separator','off',...
			 'pos',6);
       
       medalllev = uimenu('Parent',emenu,'label','Erase all level curves.',...
			  'call','pplane8(''dalllev'')',...
			  'separator','off',...
			  'pos',7);
       
       medall = uimenu('Parent',emenu,'label','Erase all graphics objects.',...
		       'call','pplane8(''dall'')',...
		       'separator','off',...
		       'pos',8);
       
       medel = uimenu('Parent',emenu,'label','Delete a graphics object.',...
		      'call','pplane8(''delete'')',...
		      'visible','on',...
		      'pos',9);
       
       menutext = uimenu('Parent',emenu,...
       ...
       menu(3) = uimenu('Parent',megraph,'label',[txname,' vs. t'],...
			'call','pplane8(''plotxy'',1)');
       
       menu(5) = uimenu('Parent',megraph,'label',[tyname,' vs. t'],...
			'call','pplane8(''plotxy'',2)');
       
       meplot3 = uimenu('Parent',megraph,'label','Both',...
			'call','pplane8(''plotxy'',3)');
       
       meplot4 = uimenu('Parent',megraph,'label','3 D',...
			'call','pplane8(''plotxy'',4)');
       
       meplot5 = uimenu('Parent',megraph,'label','Composite',...
			'call','pplane8(''plotxy'',5)');
       
       % Solutions menu
       
       solmenu = uimenu('label','Solutions','pos',3);
       menukey = uimenu('Parent',solmenu,'label','Keyboard input.','call',...
			'pplane8(''kbd'')');
       
       mesev   = uimenu('Parent',solmenu,'label','Plot several solutions.',...
			'call','pplane8(''several'')');
       
       meeqpt  = uimenu('Parent',solmenu,'label','Find an equilibrium point.',...
			'call','pplane8(''eqpt'')','separator','on');
       
       menu(4) = uimenu('Parent',solmenu,...
			'label','List computed equilibrium points.',...
			'call','pplane8(''eqptlist'')');
       
       mestunst= uimenu('Parent',solmenu,...
			'label','Plot stable and unstable orbits.',...
			'call','pplane8(''stunst'')','interrupt','on');
       
       meperiod = uimenu('Parent',solmenu,...
       ...
       periodstr = ['ud = get(gcf,''user'');',...
		    ...
		    'set(gcf,''user'',ud);',...
		    'pplane8(''periodic'');'];
       dud.period(1) = uimenu('Parent',meperiod,...
			      'label','forward',...
			      'user',1,...
			      'call', periodstr);
       dud.period(2) = uimenu('Parent',meperiod,...
			      'label','backward',...
			      'user',-1,...
			      'call', periodstr);
       dud.period(3) = uimenu('Parent',meperiod,...
       ...
       menunull = uimenu('Parent',solmenu,'label','Show nullclines.',...
			 'call',nullcall,'separator','on','tag','null');
       
       menulevel = uimenu('Parent',solmenu,'label','Plot level curves.',...
			  'call','pplane8(''level'')',...
			  'separator','off','tag','level');
       
       if dud.egg
	 menurnull = uimenu('Parent',solmenu,'label','Show polar nullclines.',...
			    'call',rnullcall,'separator','off','tag','rnull');
	 metest = uimenu('Parent',solmenu,'label','Test case',...
       ...
       meset   = uimenu('Parent',menu(1),'label','Settings.',...
			'call','pplane8(''settings'')');
       
       mesolve = uimenu('Parent',menu(1),'label','Solver.');
	...
	ode113ch = 'off';
	 ...
	 ode23tbch = 'off';
       ...
       dud.solver(1) = uimenu('Parent',mesolve,'label','Dormand Prince',...
			      'checked',dpch,...
			      'call',solverstr,'user',dpset);
       
       dud.solver(2) = uimenu('Parent',mesolve,'label','Runge-Kutta 4',...
			      'checked',rk4ch,...
			      'call',solverstr,'user',rk4set);
       
       dud.solver(3) = uimenu('Parent',mesolve,'label','ode45',...
			      'checked',ode45ch,...
			      'separator','on',...
			      'call',solverstr,'user',ode45set);
       
       dud.solver(4) = uimenu('Parent',mesolve,'label','ode23',...
			      'checked',ode23ch,...
			      'call',solverstr,'user',ode23set);
       
       dud.solver(5) = uimenu('Parent',mesolve,'label','ode113',...
			      'checked',ode113ch,...
			      'call',solverstr,'user',ode113set);
       
       dud.solver(6) = uimenu('Parent',mesolve,'label','ode15s',...
			      'checked',ode15sch,...
			      'call',solverstr,'user',ode15sset);
       
       dud.solver(7) = uimenu('Parent',mesolve,'label','ode23s',...
			      'checked',ode23sch,...
			      'call',solverstr,'user',ode23sset);
       
       dud.solver(8) = uimenu('Parent',mesolve,'label','ode23t',...
			      'checked',ode23tch,...
			      'call',solverstr,'user',ode23tset);
       
       dud.solver(9) = uimenu('Parent',mesolve,'label','ode23tb',...
			      'checked',ode23tbch,...
       ...
       medir = uimenu('Parent',menu(1),'label','Solution direction.');
       ...
       dud.direction(1) = uimenu('Parent',medir,'label','Both',...
				 'checked','on',...
				 'user',0,...
				 'call',directionstr);
       dud.dir = 0;
       
       dud.direction(2) = uimenu('Parent',medir,'label','Forward',...
				 'user',1,...
				 'call',directionstr);
       
       dud.direction(3) = uimenu('Parent',medir,'label','Back',...
				 'user',-1,...
				 'call',directionstr);
       ...
       dud.markflag = 0;
       dud.mark = uimenu('Parent',menu(1),'label','Mark initial points.',...
		       'checked','off',...
		       'call',markstr);

       meexportdata = uimenu('Parent',menu(1),'label','Export solution data.',...
			      'call','pplane8(''export'')',...
			      'separator','off','tag','dexp');
	
       meplot = uimenu('Parent',menu(1),'label','Do not plot while computing',...
		       'call',plotch,'separator','on');
       
       menu(6) = uimenu('Parent',menu(1),'label','Make the Display Window inactive.',...
